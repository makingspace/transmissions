    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(blank=True, to='contenttypes.ContentType', null=True, on_delete=models.deletion.CASCADE)),
                ('target_user', models.ForeignKey(related_name='notifications', to=USER_MODEL, on_delete=models.deletion.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            ...
            name='trigger',
            field=models.ForeignKey(blank=True, to='transmissions.Trigger', null=True, on_delete=models.deletion.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='notification',
            name='trigger_user',
            field=models.ForeignKey(related_name='notifications_sent', default=None, to=USER_MODEL, null=True, on_delete=models.deletion.CASCADE),
            preserve_default=True,
        ),
